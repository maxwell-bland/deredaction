...
public:
	...
	virtual bool useShadedFills(int type) {
		return false;
	}

	// Does this device use FillColorStop()?
	virtual bool useFillColorStop() {
		return false;
	}
	...
	virtual bool tilingPatternFill(GfxState* /*state*/, Gfx* /*gfx*/,
			Catalog* /*cat*/, Object* /*str*/, const double* /*pmat*/,
			int /*paintType*/, int /*tilingType*/, Dict* /*resDict*/,
			const double* /*mat*/, const double* /*bbox*/, int /*x0*/,
	...
	virtual bool axialShadedFill(GfxState* /*state*/,
			GfxAxialShading* /*shading*/, double /*tMin*/, double /*tMax*/) {
		return false;
	}
	...
	virtual bool radialShadedFill(GfxState* /*state*/,
			GfxRadialShading* /*shading*/, double /*sMin*/, double /*sMax*/) {
		return false;
	}
	...
	virtual bool patchMeshShadedFill(GfxState *state,
	...
	virtual void drawChar(GfxState* /*state*/, double /*x*/, double /*y*/,
			...
			double /*originY*/, CharCode /*code*/, int /*nBytes*/,
	...
	virtual void beginActualText(GfxState* /*state*/,
	...
	virtual void setSoftMaskFromImageMask(GfxState *state, Object *ref,
			Stream *str, int width, int height, bool invert, bool inlineImg,
			double *baseMatrix);
	...
	virtual bool checkTransparencyGroup(GfxState* /*state*/,
			bool /*knockout*/) {
		return true;
	}
	virtual void beginTransparencyGroup(GfxState* /*state*/,
			const double* /*bbox*/, GfxColorSpace* /*blendingColorSpace*/,
			bool /*isolated*/, bool /*knockout*/, bool /*forSoftMask*/) {
	}
	virtual void endTransparencyGroup(GfxState* /*state*/) {
	}
	virtual void paintTransparencyGroup(GfxState* /*state*/,
			const double* /*bbox*/) {
	}
	virtual void setSoftMask(GfxState* /*state*/, const double* /*bbox*/,
...
public:
	/**
	 * Each delta applied to the text space of the output device is captured
	 * and analyzed by the deredaction process.
	 */
	virtual void recordRender(GfxTextRender gtr, double val, double x,
                                       double y, double sp, double w, int unicodeIndex,
                                     double o_dx, double o_dy, GfxState *state) {
  }
  virtual GfxRenderInfo* popLastRender() { return nullptr; }
  virtual GfxRenderInfo *lastRender() { return nullptr; }
  virtual void resetRenderInfo() {}
  virtual void printRenderInfo() {};
};
